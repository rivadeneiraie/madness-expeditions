 ...
 *
 * Uso:
 *   node packages/documents/generate-pdf.js          → genera los 3 idiomas
 *   node packages/documents/generate-pdf.js es       → solo español
 *   node packages/documents/generate-pdf.js en       → solo inglés
 *   node packages/documents/generate-pdf.js pt       → solo portugués
 */
