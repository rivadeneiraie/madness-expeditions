 ...
 *
 * Uso:
 *   node packages/documents/generate-presentacion-pdf.js          → genera los 3 idiomas
 *   node packages/documents/generate-presentacion-pdf.js es       → solo español
 *   node packages/documents/generate-presentacion-pdf.js en       → solo inglés
 *   node packages/documents/generate-presentacion-pdf.js pt       → solo portugués
 */
